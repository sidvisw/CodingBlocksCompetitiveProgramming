...
void solve()
{
	...
	pii optimal={-1,-1};
	while(end<zeroIdx.size()){
		int curr=front1[zeroIdx[end]]-back1[zeroIdx[beg]]+1;
		if(curr>max1){
			max1=curr;
			optimal={back1[zeroIdx[beg]],front1[zeroIdx[end]]};
		}
		beg++;
		end++;
	}
