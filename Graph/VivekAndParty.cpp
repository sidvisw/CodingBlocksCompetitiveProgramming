...
public:
	...
	void addEdge(string a, string b, bool bidir = true, ll w = 1)
	{
		ll u = m[a];
		ll v = m[b];
	...
	void topoSort(list<string>&order)
	{
		vi indeg(vertices, 0);
		FOR(i, vertices)
		{
...
void solve(int n)
{
	...
	g.topoSort(topoorder);
	cout << "Vivek should drink beverages in this order: ";
