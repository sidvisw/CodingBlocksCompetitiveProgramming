...
/*Your functions here*/
void buildTree(vi&a,vi&tree,int s,int e,int index){
    if(s==e){
        tree[index]=a[s];
        return;
    }
...
void updateNode(vi&tree,int s,int e,int i,int inc,int index){
    if(i>e||i<s){
        return;
    }
    if(s==e){
...
void updateRange(vi&tree,int s,int e,int l,int r,int inc,int index){
    if(l>e||r<s){
        return;
    }
    if(s==e){
