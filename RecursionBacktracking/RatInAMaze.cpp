...
/*Your functions here*/
bool ratInMaze(vector<string>&mat,int x,int y){
    ...
    if(x+1<mat.size() && mat[x+1][y]=='0'){
        mat[x+1][y]='1';
        downSuccess=ratInMaze(mat,x+1,y);
        mat[x+1][y]='0';
    }
    if(y+1<mat[0].size() && mat[x][y+1]=='0'){
        mat[x][y+1]='1';
        rightSuccess=ratInMaze(mat,x,y+1);
        mat[x][y+1]='0';
    }
    return downSuccess || rightSuccess;
}
void solve()
{
    vector<string> mat;
