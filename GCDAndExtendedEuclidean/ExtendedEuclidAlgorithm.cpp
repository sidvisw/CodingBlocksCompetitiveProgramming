...
/*Your functions here*/
ll extendedEuclidsAlgorithm(ll a,ll b,ll &x, ll&y){
    if(b==0){
        x=1;
        y=0;
        return a;
    ...
    ll x1,y1;
    ll gcd=extendedEuclidsAlgorithm(b,a%b,x1,y1);
    x=y1;
    y=x1-(a/b)*y1;
    return gcd;
}
void solve()
{
    ...
    cin >> a >> b;
    ll x,y;
    cout<<"Solution for "<<a<<"x + "<<b<<"y = "<<extendedEuclidsAlgorithm(a,b,x,y)<<" is: x = "<<x<<" y = "<<y;
}