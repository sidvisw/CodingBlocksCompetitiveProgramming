...
bool areEquivalent(string s1,string s2){
    ...
    int n=s1.size();
    if(n==0)return true;
    string leftsubStrings1=s1.substr(0,n/2);
    string rightsubStrings1=s1.substr(n/2,n/2);
    string leftsubStrings2=s2.substr(0,n/2);
    string rightsubStrings2=s2.substr(n/2,n/2);
    return areEquivalent(leftsubStrings1,leftsubStrings2)&&areEquivalent(rightsubStrings1,rightsubStrings2)||areEquivalent(leftsubStrings1,rightsubStrings2)&&areEquivalent(rightsubStrings1,leftsubStrings2);
}
void solve()
{
    string s1,s2;
    cin >> s1 >> s2;
    cout<<((areEquivalent(s1,s2))? "YES" : "NO");
}