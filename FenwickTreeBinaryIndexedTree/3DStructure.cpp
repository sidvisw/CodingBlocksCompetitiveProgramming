...
void solve()
{
    ...
    while(m--){
        ...
        if(s=="UPDATE"){
            ...
            cout<<query(x2,y2,z2)-query(x1-1,y2,z2)-query(x2,y1-1,z2)-query(x2,y2,z1-1)+query(x1-1,y1-1,z2)+query(x1-1,y2,z1-1)+query(x2,y1-1,z1-1)-query(x1-1,y1-1,z1-1)<<endl;
        }
    }
}